...
bool CTDDataMgr::readRecords()
{
   ...
   */
            ...
            while (strParser.getNext(valueStr)) {
				...
				valueStr = valueStr.Mid(1, valueStr.GetLength() - 2); // This is a extra line.             
				CBFStrHelper::trim(valueStr);
				if (valueStr.IsEmpty()) {
				...
				if (pAttrib->isSetValued())   // This is a new line.
					valueStr = valueStr.Left(valueStr.GetLength() - 1);  // This is a extra line.
